...
namespace UMS.Platform.Infrastructures.FileStorage;
...
public interface IPlatformFileStorageService : IPlatformInfrastructureService
{
    ...
    public static PlatformFileStorageOptions.PublicAccessTypes? GetDefaultRootDirectoryPublicAccessType(
    ...
    /// </summary>
    Task<IPlatformFileStorageFileItem> UploadAsync(IFormFile formFile,
    ...
    /// </summary>
    Task<IPlatformFileStorageFileItem> UploadAsync(PlatformFileStorageUploader fileStorageUploader,
        CancellationToken cancellationToken = default);

    /// <summary>
    ///     Upload stream content to cloud service and return storage path.
    /// </summary>
    Task<IPlatformFileStorageFileItem> UploadAsync(Stream contentStream,
    ...
    ///     Check if file exist
    /// </summary>
    Task<bool> ExistsAsync([NotNull] string rootDirectory,
        [NotNull] string filePath);
    ...
    ///     Get stream of file content on the file storage service
    /// </summary>
    Task<Stream> GetStreamAsync([NotNull] string rootDirectory,
        [NotNull] string filePath,
        CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<Uri> CreateSharedAccessUriAsync(string fullFilePath, TimeSpan? expirationTime = null,
        CancellationToken cancellationToken = default);

    /// <summary>
    ///     Create a access uri for non-public content
    /// </summary>
    Task<Uri> CreateSharedAccessUriAsync(string rootDirectory, string filePath, TimeSpan? expirationTime = null,
        CancellationToken cancellationToken = default);

    /// <summary>
    ///     Copy file to new location
    /// </summary>
    Task<string> CopyFileAsync(string sourceFullFilePath,
