...
public class PlatformFileStorageUploader
{
    ...
    public PlatformFileStorageOptions.PublicAccessTypes PublicAccessType { get; set; } =
        PlatformFileStorageOptions.PublicAccessTypes.None;

    public static PlatformFileStorageUploader Create(Stream stream,
        ...
        string contentType = null)
    {
        return Create(stream,
            prefixDirectoryPath,
            fileName,
            IPlatformFileStorageService.GetDefaultRootDirectoryName(true),
            IPlatformFileStorageService.GetDefaultPublicAccessType(true),
            contentType);
    }

    public static PlatformFileStorageUploader Create(IFormFile formFile,
        [NotNull] string prefixDirectoryPath,
        [NotNull] string rootDirectory,
        PlatformFileStorageOptions.PublicAccessTypes publicAccessType,
    ...
    public static PlatformFileStorageUploader Create(IPlatformFile platformFileInfo,
        [NotNull] string prefixDirectoryPath,
        [NotNull] string rootDirectory,
        PlatformFileStorageOptions.PublicAccessTypes publicAccessType,
        string fileName = null,
    ...
    public static PlatformFileStorageUploader Create(IPlatformFile platformFileInfo,
        ...
        string fileDescription = null)
    {
        return Create(platformFileInfo,
            prefixDirectoryPath,
            IPlatformFileStorageService.GetDefaultRootDirectoryName(true),
            IPlatformFileStorageService.GetDefaultPublicAccessType(true),
            fileName,
