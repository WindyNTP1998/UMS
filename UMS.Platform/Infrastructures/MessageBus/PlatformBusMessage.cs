...
public class PlatformBusMessage<TPayload>
    : IPlatformTrackableBusMessage, IPlatformSelfRoutingKeyBusMessage, IPlatformWithPayloadBusMessage<TPayload>
    where TPayload : class, new()
{
    ...
    public static TBusMessage New<TBusMessage>(string trackId,
        TPayload payload,
        ...
        where TBusMessage : class, IPlatformWithPayloadBusMessage<TPayload>, IPlatformSelfRoutingKeyBusMessage,
        IPlatformTrackableBusMessage, new()
    {
        ...
        if (messageGroup != null) message.MessageGroup = messageGroup;
        if (messageAction != null) message.MessageAction = messageAction;
