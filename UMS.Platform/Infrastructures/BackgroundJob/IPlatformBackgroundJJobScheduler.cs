...
public interface IPlatformBackgroundJobScheduler
{
    ...
    public string Schedule<TJobExecutorParam>(Type jobExecutorType, TJobExecutorParam jobExecutorParam,
        DateTimeOffset enqueueAt) where TJobExecutorParam : class;
    ...
    /// <returns>Unique identifier of a created job.</returns>
    public string Schedule<TJobExecutor, TJobExecutorParam>(DateTimeOffset enqueueAt,
    ...
    /// <param name="delay">Delay, after which the job will be enqueued.</param>
    /// <returns>Unique identifier of a created job.</returns>
    public string Schedule<TJobExecutor, TJobExecutorParam>(TJobExecutorParam jobExecutorParam,
        TimeSpan? delay = null)
        where TJobExecutor : IPlatformBackgroundJobExecutor<TJobExecutorParam>
        where TJobExecutorParam : class;
    ...
    public void UpsertRecurringJob<TJobExecutor>(Func<string> cronExpression = null,
    ...
    /// </param>
    /// <param name="timeZone">Timezone for the job to run based on</param>
    public void UpsertRecurringJob<TJobExecutor, TJobExecutorParam>(TJobExecutorParam jobExecutorParam,
    ...
    /// </summary>
    public void UpsertRecurringJob(Type jobExecutorType,
        Func<string> cronExpression = null,
        TimeZoneInfo timeZone = null);
    ...
    ///     <inheritdoc cref="UpsertRecurringJob{TJobExecutor}(Func{string},TimeZoneInfo)" />
    /// </summary>
    public void UpsertRecurringJob(string recurringJobId,
    ...
    /// <summary>
    ///     Get all existed recurring jobs. Return all existed recurring job ids, list of id from
    ///     <see cref="BuildAutoRecurringJobIdByType{TJobExecutor}" />
    /// </summary>
    ...
    public void ExecuteBackgroundJob<TJobExecutor>(TJobExecutor jobExecutor)
        where TJobExecutor : IPlatformBackgroundJobExecutor;

    public void ExecuteBackgroundJob<TJobExecutor, TParam>(TJobExecutor jobExecutor, TParam jobExecutorParam)
