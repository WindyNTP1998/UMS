...
public class PlatformRecurringJobAttribute : Attribute
{
    ...
    public PlatformRecurringJobAttribute(string cronExpression, double timeZoneOffset, bool executeOnStartUp = false) :
        this(cronExpression, executeOnStartUp)
    {
        TimeZoneOffset = timeZoneOffset;
    }

    /// <inheritdoc cref="PlatformRecurringJobAttribute" />
    public PlatformRecurringJobAttribute(string cronExpression, string timeZoneId, bool executeOnStartUp = false) :
        this(cronExpression, executeOnStartUp)
    {
    ...
    public static PlatformRecurringJobAttribute GetRecurringJobAttributeInfo<TJobExecutor>()
