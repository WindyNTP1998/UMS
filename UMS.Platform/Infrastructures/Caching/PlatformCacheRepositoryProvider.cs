...
public class PlatformCacheRepositoryProvider : IPlatformCacheRepositoryProvider
{
    ...
    public PlatformCacheRepositoryProvider(IServiceProvider serviceProvider,
    ...
    public IPlatformCacheRepository Get(PlatformCacheRepositoryType cacheRepositoryType,
        bool fallbackMemoryCacheIfNotExist = true)
    {
        if (fallbackMemoryCacheIfNotExist == false) EnsureCacheRepositoryTypeRegistered(cacheRepositoryType);

        return registeredCacheRepositoriesDic.GetValueOrDefault(cacheRepositoryType) ??
               registeredCacheRepositoriesDic[PlatformCacheRepositoryType.Memory];
    }
