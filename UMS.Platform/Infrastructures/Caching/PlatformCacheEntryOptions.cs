...
public class PlatformCacheEntryOptions
{
    ...
    {
        if (value != null) AbsoluteExpirationInSeconds = value;
        return this;
    }
}

/// <summary>
///     Extend from this class to define CacheEntryOptions which read from IConfiguration. This will be register and
///     replace the default PlatformCacheEntryOptions
/// </summary>
