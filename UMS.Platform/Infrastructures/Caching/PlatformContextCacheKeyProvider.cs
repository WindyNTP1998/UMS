...
public interface IPlatformContextCacheKeyProvider
{
    ...
    PlatformCacheKey GetKey(string collection = PlatformContextCacheKeyProvider.DefaultCollection,
...
public class PlatformContextCacheKeyProvider : IPlatformContextCacheKeyProvider
{
    ...
    public virtual PlatformCacheKey GetKey(string collection = DefaultCollection,
    ...
    {
        EnsureValidProvider();
        return new PlatformCacheKey(Context,
...
{
    public static PlatformCacheKey CreateKey(string collection = DefaultCollection,
        string requestKey = DefaultRequestKey)
    {
