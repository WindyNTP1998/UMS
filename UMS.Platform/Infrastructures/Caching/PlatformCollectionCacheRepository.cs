    ...
    where TCollectionCacheKeyProvider : PlatformCollectionCacheKeyProvider
{
    ...
    Task<T> GetAsync<T>(string requestKey = PlatformContextCacheKeyProvider.DefaultRequestKey,
    ...
    Task RemoveAsync(string requestKey = PlatformContextCacheKeyProvider.DefaultRequestKey,
        CancellationToken token = default);
    ...
    Task RemoveAsync(Func<string, bool> cacheRequestKeyPredicate,
        CancellationToken token = default);

    Task RemoveAsync(Func<string[], bool> cacheRequestKeyPartsPredicate,
        CancellationToken token = default);

    Task<TData> CacheRequestAsync<TData>(Func<Task<TData>> request,
        string requestKey = PlatformContextCacheKeyProvider.DefaultRequestKey,
        PlatformCacheEntryOptions cacheOptions = null,
        CancellationToken token = default);
    ...
    Task<TData> CacheRequestUseConfigOptionsAsync<TConfigurationCacheOptions, TData>(Func<Task<TData>> request,
        string[] requestKeyParts = null,
        CancellationToken token = default)
...
/// </summary>
public abstract class PlatformCollectionCacheRepository<TCollectionCacheKeyProvider>
    : IPlatformCollectionCacheRepository<TCollectionCacheKeyProvider>
    where TCollectionCacheKeyProvider : PlatformCollectionCacheKeyProvider
{
    ...
    public Task<T> GetAsync<T>(string requestKey = PlatformContextCacheKeyProvider.DefaultRequestKey,
        CancellationToken token = default)
    {
        ...
        CancellationToken token = default)
    {
        await CacheRepository()
            .SetAsync(CollectionCacheKeyProvider.GetKey(requestKey),
                value,
                cacheOptions,
                token);
    }
    ...
    {
        await CacheRepository()
            .SetAsync(CollectionCacheKeyProvider.GetKey(requestKeyParts),
                value,
                cacheOptions,
                token);
    }
    ...
    public async Task RemoveAsync(string requestKey = PlatformContextCacheKeyProvider.DefaultRequestKey,
        CancellationToken token = default)
    {
    ...
    public async Task RemoveAsync(Func<string, bool> cacheRequestKeyPredicate,
        CancellationToken token = default)
    {
    ...
    public async Task RemoveAsync(Func<string[], bool> cacheRequestKeyPartsPredicate,
        CancellationToken token = default)
    {
        var matchCollectionKeyPredicate = CollectionCacheKeyProvider.MatchCollectionKeyPredicate();
    ...
    public Task<TData> CacheRequestAsync<TData>(Func<Task<TData>> request,
        string requestKey = PlatformContextCacheKeyProvider.DefaultRequestKey,
        PlatformCacheEntryOptions cacheOptions = null,
        CancellationToken token = default)
    {
        return CacheRepository()
            .CacheRequestAsync(request,
    ...
    public Task<TData> CacheRequestUseConfigOptionsAsync<TConfigurationCacheOptions, TData>(Func<Task<TData>> request,
        string[] requestKeyParts = null,
        CancellationToken token = default)
        where TConfigurationCacheOptions : PlatformConfigurationCacheEntryOptions
    {
        return CacheRequestAsync(request,
            requestKeyParts,
...
public class PlatformCollectionMemoryCacheRepository<TCollectionCacheKeyProvider>
    : PlatformCollectionCacheRepository<TCollectionCacheKeyProvider>
    where TCollectionCacheKeyProvider : PlatformCollectionCacheKeyProvider
{
    public PlatformCollectionMemoryCacheRepository(IPlatformCacheRepositoryProvider cacheRepositoryProvider,
        TCollectionCacheKeyProvider collectionCacheKeyProvider,
        IServiceProvider serviceProvider) : base(cacheRepositoryProvider,
...
public class PlatformCollectionDistributedCacheRepository<TCollectionCacheKeyProvider>
    : PlatformCollectionCacheRepository<TCollectionCacheKeyProvider>
    where TCollectionCacheKeyProvider : PlatformCollectionCacheKeyProvider
{
    public PlatformCollectionDistributedCacheRepository(IPlatformCacheRepositoryProvider cacheRepositoryProvider,
        TCollectionCacheKeyProvider collectionCacheKeyProvider,
        IServiceProvider serviceProvider) : base(cacheRepositoryProvider,
        collectionCacheKeyProvider,
        serviceProvider)
