...
public static class PlatformApplicationCommonUserContextKeys
{
    ...
    public static TContext SetUserRoles<TContext>(this TContext context, List<string> value)
    ...
    public static TContext SetEmail<TContext>(this TContext context, string value)
        where TContext : IDictionary<string, object>
    {
