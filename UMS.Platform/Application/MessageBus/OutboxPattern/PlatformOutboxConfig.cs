...
public class PlatformOutboxConfig
{
    ...
    ///     Ex: NextRetryProcessAfterDate = DateTime.UtcNow.AddSeconds(retryProcessFailedMessageInSecondsUnit * Math.Pow(2,
    ...
    /// <summary>
    ///     Set StandaloneScopeForOutbox = true only when apply platform for old code/project have not open and complete uow.
    ///     Remove it after finish refactoring
    /// </summary>
    ...
    ///     This to handle that if message for some reason has been set as Processing but failed to process and has not been
    ///     set
    ///     back to failed.
    /// </summary>
