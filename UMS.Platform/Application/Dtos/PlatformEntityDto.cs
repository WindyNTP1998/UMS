...
namespace UMS.Platform.Application.Dtos;
    ...
    where TEntity : IEntity<TId>, new()
{
    ...
    /// <summary>
    ///     Return the defined Id from inherit dto. This function is used to check that the dto is submitted to create or edit
    ///     in IsSubmitToUpdate function
    /// </summary>
    /// <returns></returns>
