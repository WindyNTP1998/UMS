...
public abstract class RootAuditedEntity<TEntity, TPrimaryKey, TUserId>
    : RootEntity<TEntity, TPrimaryKey>, IFullAuditedEntity<TUserId>
    where TEntity : Entity<TEntity, TPrimaryKey>, new()
{
    ...
    public IUserAuditedEntity SetLastUpdatedBy(object value)
    {
        if (value != typeof(TUserId).GetDefaultValue()) LastUpdatedBy = (TUserId)value;
