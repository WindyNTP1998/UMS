...
{
    /// <summary>
    ///     Update property even if it's setter protected or private and add
    ///     <see cref="ISupportDomainEventsEntity.FieldUpdatedDomainEvent{TValue}" />
    /// </summary>
    public static TEntity SetPropertyIncludeValueUpdatedEvent<TEntity, TValue>(this TEntity entity,
        PropertyInfo propertyInfo, TValue newValue)
    ...
    /// </summary>
    public static TEntity SetPropertyIncludeValueUpdatedEvent<TEntity, TValue>(this TEntity entity,
        Expression<Func<TEntity, TValue>> property, TValue newValue)
        where TEntity : IEntity
    {
        if (entity is ISupportDomainEventsEntity supportDomainEventsEntity)
        {
    ...
    public static TEntity AddFieldUpdatedEvent<TEntity, TValue>(this TEntity entity,
    ...
    {
        entity.AddDomainEvent(propertyValueUpdatedDomainEvent,
            ISupportDomainEventsEntity.DomainEvent
                .GetDefaultEventName<ISupportDomainEventsEntity.FieldUpdatedDomainEvent>());
        return entity;
    }

    public static TEntity AddFieldUpdatedEvent<TEntity, TValue>(this TEntity entity, string propertyName,
        TValue originalValue, TValue newValue)
        where TEntity : ISupportDomainEventsEntity
    {
    ...
    public static TEntity AddFieldUpdatedEvent<TEntity, TValue>(this TEntity entity, PropertyInfo propertyInfo,
        TValue originalValue, TValue newValue)
        where TEntity : ISupportDomainEventsEntity
    {
        return entity.AddFieldUpdatedEvent(
            ISupportDomainEventsEntity.FieldUpdatedDomainEvent<TValue>.Create(propertyInfo.Name, originalValue,
                newValue));
    }
    ...
    {
        return entity.AddFieldUpdatedEvent(
            ISupportDomainEventsEntity.FieldUpdatedDomainEvent<TValue>.Create(property.GetPropertyName(), originalValue,
                newValue));
    }
    ...
    public static List<ISupportDomainEventsEntity.FieldUpdatedDomainEvent<TValue>> FindFieldUpdatedDomainEvents<TEntity,
        TValue>(this TEntity entity,
        string propertyName)
        where TEntity : ISupportDomainEventsEntity
    {
        return entity.GetDomainEvents()
    ...
    public static List<ISupportDomainEventsEntity.FieldUpdatedDomainEvent> GetFieldUpdatedDomainEvents<TEntity>(
        this TEntity entity)
        where TEntity : ISupportDomainEventsEntity
    {
        return entity.GetDomainEvents()
