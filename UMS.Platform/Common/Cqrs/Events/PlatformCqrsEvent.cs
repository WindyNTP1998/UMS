...
public interface IPlatformCqrsEvent : INotification
{
    ...
    /// <summary>
    ///     Add handler type fullname If you want to force wait handler execution immediately successfully to continue. By
    ///     default, handlers for entity event executing
    ...
    /// <summary>
    ///     Set handler type fullname If you want to force wait handler to be handling successfully to continue. By default,
    ///     handlers for entity event executing
    ///     in background thread and you dont need to wait for it. The command will return immediately. <br />
    ///     Sometime you could want to wait for handler done
    /// </summary>
