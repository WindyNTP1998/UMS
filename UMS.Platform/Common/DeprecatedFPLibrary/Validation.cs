...
namespace UMS.Platform.Common.DeprecatedFPLibrary;
...
public static partial class F
{
    ...
    /// </summary>
    public static Validation<IEnumerable<TValidation>> Aggregate<TValidation>(
        this IEnumerable<Validation<TValidation>> validations)
    {
    ...
    /// </summary>
    public static Validation<IEnumerable<TValidation>> Aggregate<TValidation>(
        params Validation<TValidation>[] validations)
    {
        return Aggregate(validations.AsEnumerable());
    }

    public static Validation<ValueTuple> Combine<TValidation>(
        this IEnumerable<Func<Validation<TValidation>>> validations)
    {
...
public static class Validation
{
    ...
    public static Validation<TRr> For<TR, TRr>(this Validation<TR> @this,
        TRr value)
    {
        return @this.IsValid
            ? F.Valid(value)
    ...
    public static Validation<T> WithErrorMsg<T>(this Validation<T> @this,
    ...
    public static Validation<TRr> Then<TR, TRr>(this Validation<TR> @this,
        Func<TR, TRr> f)
    {
        return @this.IsValid
    ...
    public static Validation<TR> And<T, TR>(this Validation<T> val,
        Func<T, Validation<TR>> f)
    {
        return val.Match(p => F.Invalid(p),
            f);
    }

    public static Validation<T> And<T>(this Validation<T> val,
    ...
    public static Validation<TR> Then<T, TR>(this Validation<T> val,
    ...
    public static async Task<Validation<TR>> Then<T, TR>(this Validation<T> val,
        Func<T, Task<Validation<TR>>> f)
    {
        return await val.Match(reasons => F.Invalid<TR>(reasons).ToTask(),
            f);
    }

    public static async Task<Validation<TR>> Then<T, TR>(this Validation<T> @this,
        Func<T, Task<TR>> func)
    {
        return await @this.Match(reasons => F.Invalid<TR>(reasons).ToTask(),
            t => func(t).Then(F.Valid));
    }

    public static async Task<Validation<TR>> ThenAsync<T, TR>(this Task<Validation<T>> valTask,
        Func<T, Task<TR>> f)
    {
