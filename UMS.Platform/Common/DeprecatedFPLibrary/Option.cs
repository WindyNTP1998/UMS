...
public static class OptionExt
{
    ...
    public static Task<TR> MatchAsync<T, TR>(this Task<Option<T>> optTask,
        Func<Task<TR>> none,
        Func<T, Task<TR>> some)
    {
        return optTask.Then(opt => opt.Match(none, some));
    ...
    {
        return opt.Match(() => F.Valid(F.Unit()).ToTask(),
            validateFn);
    }
    ...
    public static Option<T> Where<T>(this Option<T> optT,
        Func<T, bool> predicate)
    {
        return optT.Match(() => F.None,
