    ...
    public static class DateTimeParser
    {
        ...
        public static DateTime? Parse(string value)
        {
            ...
            if (DateTime.TryParse(value, out var tryParsedValue))
                return tryParsedValue.PipeIf(tryParsedValue.Kind == DateTimeKind.Unspecified,
                    _ => _.SpecifyKind(DateTimeKind.Utc));
            ...
            if (DateTime.TryParseExact(value,
                ...
                return tryParseExactValue.PipeIf(tryParseExactValue.Kind == DateTimeKind.Unspecified,
                    _ => _.SpecifyKind(DateTimeKind.Utc));
        ...
        public static DateTime? ToPredefinedDateTimeFormat(string dateTime, string[] dateTimeFormats = null)
        {
            ...
            return DateTime.TryParseExact(dateTime.Trim(),
