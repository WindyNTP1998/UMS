...
using UMS.Platform.Common.Logging;
...
public static partial class Util
{
    public static class TaskRunner
    {
        ...
        /// </summary>
        public static async Task QueueDelayAsyncAction(Func<CancellationToken, Task> action,
            TimeSpan delayTime,
            CancellationToken cancellationToken = default)
        {
            if (delayTime > TimeSpan.Zero) await Task.Delay(delayTime, cancellationToken);
        ...
        ///     Execute an action after a given of time.
        /// </summary>
        public static async Task<TResult> QueueDelayAsyncAction<TResult>(Func<CancellationToken, Task<TResult>> action,
            TimeSpan delayTime,
            CancellationToken cancellationToken = default)
        {
            if (delayTime > TimeSpan.Zero) await Task.Delay(delayTime, cancellationToken);
        ...
        ///     Execute an action after a given of time.
        /// </summary>
        public static async Task QueueDelayAction(Action action,
            TimeSpan delayTime,
            CancellationToken cancellationToken = default)
        {
            if (delayTime > TimeSpan.Zero) await Task.Delay(delayTime, cancellationToken);
        ...
        public static void QueueActionInBackground(Func<Task> action,
        ...
        public static void QueueActionInBackground<TResult>(Func<Task<TResult>> action,
            Func<ILogger> loggerFactory,
            int delayTimeSeconds = 0,
            CancellationToken cancellationToken = default)
        {
        ...
        public static void QueueActionInBackground(Action action,
            Func<ILogger> loggerFactory,
            int delayTimeSeconds = 0,
            CancellationToken cancellationToken = default)
        {
        ...
        public static async Task QueueIntervalAsyncAction(Func<CancellationToken, Task> action,
        ...
        public static void QueueIntervalAsyncActionInBackground(Func<CancellationToken, Task> action,
            int intervalTimeInSeconds,
            Func<ILogger> loggerFactory,
            int? maximumIntervalExecutionCount = null,
            bool executeOnceImmediately = true,
            ...
            Task.Run(async () =>
                {
                    ...
                    try
                    {
                        await QueueIntervalAsyncAction(action, intervalTimeInSeconds, maximumIntervalExecutionCount,
                            executeOnceImmediately, cancellationToken);
                    }
                    catch (Exception ex)
                    {
                        loggerFactory().LogError(ex, "Run in background thread failed.");
        ...
        public static async Task<T> CatchExceptionContinueThrowAsync<T, TException>(Func<Task<T>> func,
        ...
        ///     afterExecution: elapsedMilliseconds => { } is an optional action to execute. It's input is the task
        ///     ElapsedMilliseconds of asyncTask execution.
        /// </summary>
        public static async Task ProfileExecutionAsync(Func<Task> asyncTask,
        ...
        /// <summary>
        ///     Help to profiling an asyncTask. <br />
        ///     afterExecution: (result, elapsedMilliseconds) => { } is an optional action to execute. It's input is the task
        ///     ElapsedMilliseconds of asyncTask execution.
        /// </summary>
        public static async Task<TResult> ProfileExecutionAsync<TResult>(Func<Task<TResult>> asyncTask,
        ...
        ///     ElapsedMilliseconds of asyncTask execution.
        /// </summary>
        public static void ProfileExecution(Action action,
            Action<double> afterExecution = null,
            Action beforeExecution = null)
        {
            beforeExecution?.Invoke();
        ...
        ///     ElapsedMilliseconds of asyncTask execution.
        /// </summary>
        public static TResult ProfileExecution<TResult>(Func<TResult> action,
            Action<TResult, double> afterExecution = null,
            Action beforeExecution = null)
        {
            beforeExecution?.Invoke();
        ...
        public static async Task<ValueTuple<T1, T2, T3>> WhenAll<T1, T2, T3>(Task<T1> task1,
            Task<T2> task2,
            Task<T3> task3)
        {
        ...
        public static async Task<ValueTuple<T1, T2, T3, T4>> WhenAll<T1, T2, T3, T4>(Task<T1> task1,
            Task<T2> task2,
            Task<T3> task3,
            Task<T4> task4)
        {
        ...
        public static async Task<ValueTuple<T1, T2, T3, T4, T5>> WhenAll<T1, T2, T3, T4, T5>(Task<T1> task1,
            Task<T2> task2,
            Task<T3> task3,
            Task<T4> task4,
            Task<T5> task5)
        ...
        public static async Task<ValueTuple<T1, T2, T3, T4, T5, T6>> WhenAll<T1, T2, T3, T4, T5, T6>(Task<T1> task1,
            Task<T2> task2,
            Task<T3> task3,
            Task<T4> task4,
            Task<T5> task5,
        ...
        /// <returns></returns>
        public static Task WaitRetryThrowFinalExceptionAsync<TException>(Func<Task> executeFunc,
            ...
            Action<Exception, TimeSpan, int, Context> onRetry = null) where TException : Exception
        {
            return Policy
                ...
                .ExecuteAndThrowFinalExceptionAsync(executeFunc,
                    onBeforeThrowFinalExceptionFn ?? (exception => { }));
        }

        /// <inheritdoc
        ///     cref="WaitRetryThrowFinalExceptionAsync{TException}(Func{Task},Func{int,TimeSpan},int,Action{Exception},Action{Exception,TimeSpan,int,Context})" />
        public static Task<T> WaitRetryThrowFinalExceptionAsync<T, TException>(Func<Task<T>> executeFunc,
            Func<int, TimeSpan> sleepDurationProvider = null,
            int retryCount = 1,
            Action<Exception> onBeforeThrowFinalExceptionFn = null,
            Action<Exception, TimeSpan, int, Context> onRetry = null) where TException : Exception
        ...
        /// <inheritdoc
        ///     cref="WaitRetryThrowFinalExceptionAsync{TException}(Func{Task},Func{int,TimeSpan},int,Action{Exception},Action{Exception,TimeSpan,int,Context})" />
        public static Task WaitRetryThrowFinalExceptionAsync(Func<Task> executeFunc,
            Func<int, TimeSpan> sleepDurationProvider = null,
            int retryCount = 1,
            Action<Exception> onBeforeThrowFinalExceptionFn = null,
            Action<Exception, TimeSpan, int, Context> onRetry = null)
        {
            return WaitRetryThrowFinalExceptionAsync<Exception>(executeFunc,
        ...
        /// <inheritdoc
        ///     cref="WaitRetryThrowFinalExceptionAsync{TException}(Func{Task},Func{int,TimeSpan},int,Action{Exception},Action{Exception,TimeSpan,int,Context})" />
        public static Task<T> WaitRetryThrowFinalExceptionAsync<T>(Func<Task<T>> executeFunc,
            Func<int, TimeSpan> sleepDurationProvider = null,
            int retryCount = 1,
            Action<Exception> onBeforeThrowFinalExceptionFn = null,
            Action<Exception, TimeSpan, int, Context> onRetry = null)
        {
            return WaitRetryThrowFinalExceptionAsync<T, Exception>(executeFunc,
                sleepDurationProvider,
                retryCount,
                onBeforeThrowFinalExceptionFn,
                onRetry);
        ...
        public static Task<PolicyResult> WaitRetryAsync(Func<Task> executeFunc,
            Func<int, TimeSpan> sleepDurationProvider = null,
            int retryCount = 1,
            Action<Exception, TimeSpan, int, Context> onRetry = null)
        {
        ...
        public static Task<PolicyResult<T>> WaitRetryAsync<T>(Func<Task<T>> executeFunc,
            Func<int, TimeSpan> sleepDurationProvider = null,
            int retryCount = 1,
            Action<Exception, TimeSpan, int, Context> onRetry = null)
        {
        ...
        /// <param name="onRetry">onRetry: (exception,timeSpan,currentRetry,context)</param>
        /// <returns></returns>
        public static T WaitRetryThrowFinalException<T>(Func<T> executeFunc,
            Func<int, TimeSpan> sleepDurationProvider = null,
            int retryCount = 1,
            Action<Exception> onBeforeThrowFinalExceptionFn = null,
            Action<Exception, TimeSpan, int, Context> onRetry = null)
        {
            return Policy
                ...
                .ExecuteAndThrowFinalException(executeFunc,
                    onBeforeThrowFinalExceptionFn ?? (exception => { }));
        }

        public static PolicyResult<T> WaitRetry<T>(Func<T> executeFunc,
            Func<int, TimeSpan> sleepDurationProvider = null,
            int retryCount = 1,
            Action<Exception, TimeSpan, int, Context> onRetry = null)
        {
        ...
        /// <param name="onRetry">onRetry: (exception,timeSpan,currentRetry,context)</param>
        /// <returns></returns>
        public static void WaitRetryThrowFinalException(Action executeAction,
            Func<int, TimeSpan> sleepDurationProvider = null,
            int retryCount = 1,
            Action<Exception> onBeforeThrowFinalExceptionFn = null,
            Action<Exception, TimeSpan, int, Context> onRetry = null)
        {
            Policy
                ...
                .ExecuteAndThrowFinalException(executeAction,
                    onBeforeThrowFinalExceptionFn ?? (exception => { }));
        }

        public static PolicyResult WaitRetry(Action executeAction,
            Func<int, TimeSpan> sleepDurationProvider = null,
            int retryCount = 1,
            Action<Exception, TimeSpan, int, Context> onRetry = null)
        {
        ...
        public static T WaitRetryThrowFinalException<T, TException>(Func<T> executeFunc,
            Func<int, TimeSpan> sleepDurationProvider = null,
            int retryCount = 1,
        ...
        public static PolicyResult<T> WaitRetry<T, TException>(Func<T> executeFunc,
            Func<int, TimeSpan> sleepDurationProvider = null,
            int retryCount = 1,
            Action<Exception, TimeSpan, int, Context> onRetry = null) where TException : Exception
        {
            ...
            string waitForMsg = null)
        {
            ...
            while (!condition())
                if ((DateTime.UtcNow - startWaitTime).TotalMilliseconds < maxWaitMilliseconds)
                    ...
                    throw new TimeoutException($"WaitUntil is timed out (Max: {maxWaitSeconds} seconds)." +
        ...
        public static bool TryWaitUntil(Func<bool> condition,
            double maxWaitSeconds = DefaultWaitUntilMaxSeconds,
            double waitIntervalSeconds = DefaultWaitIntervalSeconds,
            string waitForMsg = null)
        {
            try
            {
                WaitUntil(condition, maxWaitSeconds, waitIntervalSeconds,
                    waitForMsg);
        ...
        public static async Task<bool> TryWaitUntilAsync(Func<Task<bool>> condition,
            double maxWaitSeconds = DefaultWaitUntilMaxSeconds,
            double waitIntervalSeconds = DefaultWaitIntervalSeconds,
            string waitForMsg = null)
        {
            try
            {
                await WaitUntilAsync(condition, maxWaitSeconds, waitIntervalSeconds,
                    waitForMsg);
        ...
        public static TResult WaitUntilGetValidResult<T, TResult>(T target,
        ...
        public static TResult TryWaitUntilGetValidResult<T, TResult>(T target,
            Func<T, TResult> getResult,
            Func<TResult, bool> condition,
            double maxWaitSeconds = DefaultWaitUntilMaxSeconds,
            string waitForMsg = null)
        ...
        /// </summary>
        public static T WaitUntil<T, TAny>(T target,
            Func<bool> condition,
            ...
            string waitForMsg = null)
        {
            ...
            {
                throw new Exception($"{(waitForMsg != null ? $"WaitFor: '{waitForMsg}'" : "Wait")} failed." +
                                    $"{Environment.NewLine}Error: {e.Message}");
            }
        }

        public static T WaitUntil<T>(T target,
            Func<bool> condition,
            Action<T> continueWaitOnlyWhen,
            double maxWaitSeconds = DefaultWaitUntilMaxSeconds,
            string waitForMsg = null)
        {
            return WaitUntil(target, condition, continueWaitOnlyWhen?.ToFunc(),
                maxWaitSeconds, waitForMsg);
        }

        public static TResult WaitUntilGetValidResult<T, TResult, TAny>(T target,
            Func<T, TResult> getResult,
            Func<TResult, bool> condition,
            Func<T, TAny> continueWaitOnlyWhen = null,
            double maxWaitSeconds = DefaultWaitUntilMaxSeconds,
        ...
        public static TResult WaitUntilGetValidResult<T, TResult>(T target,
            ...
            string waitForMsg = null)
        {
            return WaitUntilGetValidResult(target, getResult, condition,
                continueWaitOnlyWhen?.ToFunc(), maxWaitSeconds, waitForMsg);
        }

        public static void WaitUntilSuccess<T>(T target,
            Action<T> action,
            double maxWaitSeconds = DefaultWaitUntilMaxSeconds,
            string waitForMsg = null)
        {
            WaitUntilSuccess<T, object>(target, action, null,
                maxWaitSeconds, waitForMsg);
        }

        public static void WaitUntilSuccess<T, TAny>(T target,
            Action<T> action,
            Func<T, TAny> continueWaitOnlyWhen = null,
            double maxWaitSeconds = DefaultWaitUntilMaxSeconds,
            string waitForMsg = null)
        ...
        public static TResult WaitUntilGetSuccess<T, TResult>(T target,
            Func<T, TResult> getResult,
            double maxWaitSeconds = DefaultWaitUntilMaxSeconds,
            string waitForMsg = null)
        {
            return WaitUntilGetSuccess(target, getResult, null,
                maxWaitSeconds, waitForMsg);
        }

        public static TResult WaitUntilGetSuccess<T, TResult, TAny>(T target,
            Func<T, TResult> getResult,
            Func<T, TAny> continueWaitOnlyWhen = null,
            double maxWaitSeconds = DefaultWaitUntilMaxSeconds,
            string waitForMsg = null)
        ...
        public static TResult WaitUntilGetSuccess<T, TResult>(T target,
            ...
            string waitForMsg = null)
        {
            return WaitUntilGetSuccess(target, getResult, continueWaitOnlyWhen?.ToFunc(),
                maxWaitSeconds, waitForMsg);
        }

        public static T WaitUntilToDo<T>(Func<bool> condition,
            Func<T> action,
            double maxWaitSeconds = DefaultWaitUntilMaxSeconds,
            double waitIntervalSeconds = DefaultWaitIntervalSeconds,
            string waitForMsg = null)
        ...
        public static async Task WaitUntilToDo(Func<Task<bool>> condition,
            Func<Task> action,
            double maxWaitSeconds = DefaultWaitUntilMaxSeconds,
            double waitIntervalSeconds = DefaultWaitIntervalSeconds,
            string waitForMsg = null)
        ...
        public static void WaitUntilToDo(Func<bool> condition,
            Action action,
            double maxWaitSeconds = DefaultWaitUntilMaxSeconds,
            double waitIntervalSeconds = DefaultWaitIntervalSeconds,
            string waitForMsg = null)
        ...
        public static TTarget WaitUntilHasMatchedCase<TSource, TTarget>(WhenCase<TSource, TTarget> whenDo,
            double maxWaitSeconds = DefaultWaitUntilMaxSeconds,
            double waitIntervalSeconds = DefaultWaitIntervalSeconds,
            string waitForMsg = null)
        {
        ...
        public static TSource WaitUntilHasMatchedCase<TSource>(WhenCase<TSource> whenDo,
            double maxWaitSeconds = DefaultWaitUntilMaxSeconds,
            double waitIntervalSeconds = DefaultWaitIntervalSeconds,
            string waitForMsg = null)
        {
            WaitUntilHasMatchedCase(whenDo.As<WhenCase<TSource, ValueTuple>>(), maxWaitSeconds, waitIntervalSeconds,
                waitForMsg);

            return whenDo.Source;
        }

        public static void WaitRetryDoUntil(Action action,
            Func<bool> until,
            double maxWaitSeconds = DefaultWaitUntilMaxSeconds,
            double waitIntervalSeconds = DefaultWaitIntervalSeconds,
            string waitForMsg = null)
        {
            ...
            while (!until())
            {
                if ((DateTime.UtcNow - startWaitTime).TotalMilliseconds < maxWaitMilliseconds)
                    ...
                    throw new TimeoutException($"WaitRetryDoUntil is timed out (Max: {maxWaitSeconds} seconds)." +
                                               $"{(waitForMsg != null ? $"{Environment.NewLine}WaitFor: {waitForMsg}" : "")}");
        ...
        public static T WaitRetryDoUntil<T>(Func<T> action,
            Func<bool> until,
            double maxWaitSeconds = DefaultWaitUntilMaxSeconds,
            double waitIntervalSeconds = DefaultWaitIntervalSeconds,
            string waitForMsg = null)
        ...
        public static async Task WaitRetryDoUntilAsync(Func<Task> action,
            ...
            string waitForMsg = null)
        {
            ...
            {
                if ((DateTime.UtcNow - startWaitTime).TotalMilliseconds >= maxWaitMilliseconds)
                    throw new TimeoutException($"DoUntil is timed out (Max: {maxWaitSeconds} seconds)." +
                                               $"{(waitForMsg != null ? $"{Environment.NewLine}WaitFor: {waitForMsg}" : "")}");
        ...
        public static async Task<T> WaitRetryDoUntilAsync<T>(Func<Task<T>> action,
            Func<Task<bool>> until,
            double maxWaitSeconds = DefaultWaitUntilMaxSeconds,
            double waitIntervalSeconds = DefaultWaitIntervalSeconds,
            string waitForMsg = null)
