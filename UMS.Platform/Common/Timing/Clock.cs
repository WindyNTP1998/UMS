...
namespace UMS.Platform.Common.Timing;
...
public static class Clock
{
        ...
        DateTimeKind? kind = null)
    {
        return new DateTime(year, month, day,
            hour, minute, second).SpecifyKind(kind ?? Kind);
    }

    public static DateTime NewUtcDate(int year, int month, int day,
        int hour = 0, int minute = 0, int second = 0)
    {
        return new DateTime(year, month, day,
            hour, minute, second).SpecifyKind(DateTimeKind.Utc);
    }

    public static DateTime NewLocalDate(int year, int month, int day,
        int hour = 0, int minute = 0, int second = 0)
    {
        return new DateTime(year, month, day,
            hour, minute, second).SpecifyKind(DateTimeKind.Local);
    }
