...
public static class ThreadExtensions
{
    ...
    public static async Task ExecuteLockActionAsync(this SemaphoreSlim lockObj, Func<Task> action,
    ...
    public static async Task<T> ExecuteLockActionAsync<T>(this SemaphoreSlim lockObj, Func<Task<T>> action,
        CancellationToken cancellationToken = default)
    {
        try
        {
