...
public static class TaskExtension
{
    ...
    /// </summary>
    public static async Task<TR> Then<T, TR>(this Task<T> task,
        Func<T, TR> f)
    {
        return f(await task);
    }
    ...
    ///     Apply using functional programming to map from Task[A] => (A) => B => Task[B]
    /// </summary>
    public static async Task<TR> Then<TR>(this Task task,
        Func<TR> f)
    {
        await task;
        return f();
    ...
    public static async Task<TR> Then<T1, T2, TR>(this Task<ValueTuple<T1, T2>> task,
    ...
    public static async Task<TR> Then<T1, T2, T3, TR>(this Task<ValueTuple<T1, T2, T3>> task,
    ...
    public static async Task<TR> Then<T1, T2, T3, T4, TR>(this Task<ValueTuple<T1, T2, T3, T4>> task,
    ...
    public static async Task<TR> Then<T1, T2, T3, T4, T5, TR>(this Task<ValueTuple<T1, T2, T3, T4, T5>> task,
        Func<T1, T2, T3, T4, T5, Task<TR>> nextTask)
    {
        var taskResult = await task;
        return await nextTask(taskResult.Item1, taskResult.Item2, taskResult.Item3,
            taskResult.Item4, taskResult.Item5);
    }

    public static async Task<T> ThenAction<T>(this Task<T> task,
        Action<T> action)
    {
    ...
    public static async Task<T> ThenActionAsync<T>(this Task<T> task,
    ...
    public static async Task<T> ThenActionIf<T>(this Task<T> task,
        bool actionIf,
        Action<T> action)
    {
        var targetValue = await task;
    ...
    public static async Task<T> ThenActionIfAsync<T>(this Task<T> task,
        bool actionIf,
        Func<T, Task> nextTask)
    {
        var targetValue = await task;
    ...
    /// </summary>
    public static async Task<T> ThenSideEffectAction<T>(this Task<T> task,
        Action<T> action,
        ILogger logger)
    {
        var targetValue = await task;
    ...
    public static async Task ThenSideEffectActionAsync(this Task task,
        Func<Task> nextTask,
        ILogger logger)
    {
        await task;
    ...
    ///     Side effect call other action, which will not affect the main action flow if error. Just a side effect action
    /// </summary>
    public static async Task<T> ThenSideEffectActionAsync<T>(this Task<T> task,
        Func<T, Task> nextTask,
        ILogger logger)
    {
        var targetValue = await task;
    ...
    public static Task<TR> Then<T, TR>(this Task<T> task,
    ...
    public static async Task<TResult> ThenIf<TTarget, TResult>(this Task<TTarget> task,
    ...
    public static async Task<TResult> ThenIfOrDefault<TTarget, TResult>(this Task<TTarget> task,
        Func<TTarget, bool> @if,
    ...
    public static async Task<ValueTuple<T, T1, T2>> ThenGetWith<T, T1, T2>(this Task<T> task, Func<T, T1> getWith1,
        Func<T, T1, T2> getWith2)
    {
        var (value, value1) = await task.ThenGetWith(getWith1);
        return (value, value1, getWith2(value, value1));
    }

    public static async Task<ValueTuple<T, T1, T2>> ThenGetWith<T, T1, T2>(this Task<T> task,
        Func<T, Task<T1>> getWith1, Func<T, T1, Task<T2>> getWith2)
    {
        var (value, value1) = await task.ThenGetWith(getWith1);
    ...
    ///     which returns an instance that has a GetResult() method. When used on a faulted Task, GetResult() will propagate
    ///     the original exception (this is how “await task;” gets its behavior). <br />
    ...
    public static Task<T> Recover<T>(this Task<T> task,
    ...
    ///     Wait a period of time then do a given action
    /// </summary>
    public static TResult WaitThen<T, TResult>(this T target,
    ...
    public static T WaitUntil<T>(this T target,
    ...
    public static T WaitUntil<T>(this T target,
        ...
        string waitForMsg = null)
    {
        return Util.TaskRunner.WaitUntil(target, condition, continueWaitOnlyWhen,
            maxWaitSeconds, waitForMsg);
    }

    public static TResult WaitUntilGetValidResult<T, TResult>(this T target,
        Func<T, TResult> getResult,
        Func<TResult, bool> condition,
        double maxWaitSeconds = Util.TaskRunner.DefaultWaitUntilMaxSeconds,
        string waitForMsg = null)
    {
        return Util.TaskRunner.WaitUntilGetValidResult(target, getResult, condition,
            maxWaitSeconds, waitForMsg);
    }
    ...
    {
        return Util.TaskRunner.WaitUntilGetValidResult(target, getResult, condition,
            continueWaitOnlyWhen, maxWaitSeconds, waitForMsg);
    }

    /// <inheritdoc cref="Util.TaskRunner.WaitUntil{T}" />
    public static T WaitUntil<T, TAny>(this T target,
        Func<T, bool> condition,
        Func<T, TAny> continueWaitOnlyWhen = null,
        double maxWaitSeconds = Util.TaskRunner.DefaultWaitUntilMaxSeconds,
        string waitForMsg = null)
    {
        return Util.TaskRunner.WaitUntil(target, () => condition(target), continueWaitOnlyWhen,
            maxWaitSeconds, waitForMsg);
    }
    ...
    public static T WaitUntil<T>(this T target,
        ...
        string waitForMsg = null)
    {
        return Util.TaskRunner.WaitUntil(target, () => condition(target), continueWaitOnlyWhen.ToFunc(),
            maxWaitSeconds, waitForMsg);
    }

    public static TResult WaitUntilGetValidResult<T, TResult, TAny>(this T target,
        Func<T, TResult> getResult,
        Func<TResult, bool> condition,
        Func<T, TAny> continueWaitOnlyWhen = null,
        double maxWaitSeconds = Util.TaskRunner.DefaultWaitUntilMaxSeconds,
    ...
    /// </summary>
    public static TResult TryWaitUntilGetValidResult<T, TResult, TAny>(this T target,
        Func<T, TResult> getResult,
        Func<TResult, bool> condition,
        Func<T, TAny> continueWaitOnlyWhen = null,
        double maxWaitSeconds = Util.TaskRunner.DefaultWaitUntilMaxSeconds,
    ...
    public static TResult WaitUntilNotNull<T, TResult>(this T target,
        Func<T, TResult> getResult,
        double maxWaitSeconds = Util.TaskRunner.DefaultWaitUntilMaxSeconds,
        string waitForMsg = null)
    {
        return WaitUntilGetValidResult(target, getResult, _ => _ != null,
            maxWaitSeconds, waitForMsg);
    }

    public static TResult WaitUntilGetSuccess<T, TResult>(this T target,
        Func<T, TResult> getResult,
        double maxWaitSeconds = Util.TaskRunner.DefaultWaitUntilMaxSeconds,
        string waitForMsg = null)
    {
        return Util.TaskRunner.WaitUntilGetSuccess(target, getResult, maxWaitSeconds,
            waitForMsg);
    }

    public static TResult WaitUntilGetSuccess<T, TResult, TAny>(this T target,
        Func<T, TResult> getResult,
        Func<T, TAny> continueWaitOnlyWhen = null,
        double maxWaitSeconds = Util.TaskRunner.DefaultWaitUntilMaxSeconds,
        string waitForMsg = null)
    {
        return Util.TaskRunner.WaitUntilGetSuccess(target, getResult, continueWaitOnlyWhen,
            maxWaitSeconds, waitForMsg);
    }
    ...
    public static T WaitUntilToDo<T>(this T target,
        Func<T, bool> condition,
        Action<T> action,
        double maxWaitSeconds = Util.TaskRunner.DefaultWaitUntilMaxSeconds,
        string waitForMsg = null)
    {
        Util.TaskRunner.WaitUntilToDo(() => condition(target), () => action(target), maxWaitSeconds,
            waitForMsg: waitForMsg);

        return target;
    }

    public static TResult WaitUntilToDo<T, TResult>(this T target,
        Func<T, bool> condition,
        Func<T, TResult> action,
        double maxWaitSeconds = Util.TaskRunner.DefaultWaitUntilMaxSeconds,
        string waitForMsg = null)
    {
        return Util.TaskRunner.WaitUntilToDo(() => condition(target), () => action(target), maxWaitSeconds,
            waitForMsg: waitForMsg);
    }

    public static async Task<T> WaitUntilToDo<T>(this T target,
        Func<T, bool> condition,
        Func<Task<T>> action,
        double maxWaitSeconds = Util.TaskRunner.DefaultWaitUntilMaxSeconds,
        string waitForMsg = null)
    {
        await Util.TaskRunner.WaitUntilToDo(() => condition(target), action, maxWaitSeconds,
            waitForMsg: waitForMsg);

        return target;
    }

    public static Task<TResult> WaitUntilToDo<T, TResult>(this T target,
        Func<T, bool> condition,
    ...
    public static TTarget WaitUntilHasMatchedCase<TSource, TTarget>(this TSource source,
    ...
    public static TSource WaitUntilHasMatchedCase<TSource>(this TSource source,
    ...
    public static T WaitRetryDoUntil<T>(this T target,
        Action<T> action,
        Func<T, bool> until,
        double maxWaitSeconds = Util.TaskRunner.DefaultWaitUntilMaxSeconds,
        string waitForMsg = null)
    {
        Util.TaskRunner.WaitRetryDoUntil(() => action(target), () => until(target), maxWaitSeconds,
            waitForMsg: waitForMsg);
    ...
    public static async Task<ValueTuple<TR1, TR2>> ThenGetAll<TR1, TR2>(this Task task,
        Func<TR1> fr1,
        Func<TR2> fr2)
    {
        await task;
    ...
    public static async Task<ValueTuple<TR1, TR2, TR3>> ThenGetAll<TR1, TR2, TR3>(this Task task,
        Func<TR1> fr1,
        Func<TR2> fr2,
        Func<TR3> fr3)
    {
    ...
    public static async Task<ValueTuple<TR1, TR2, TR3, TR4>> ThenGetAll<TR1, TR2, TR3, TR4>(this Task task,
        Func<TR1> fr1,
        Func<TR2> fr2,
        Func<TR3> fr3,
        Func<TR4> fr4)
    ...
    public static async Task<ValueTuple<TR1, TR2, TR3, TR4, TR5>> ThenGetAll<TR1, TR2, TR3, TR4, TR5>(this Task task,
        Func<TR1> fr1,
        Func<TR2> fr2,
        Func<TR3> fr3,
        Func<TR4> fr4,
    ...
    public static async Task<ValueTuple<TR1, TR2>> ThenGetAll<T, TR1, TR2>(this Task<T> task,
        Func<T, TR1> fr1,
        Func<T, TR2> fr2)
    {
    ...
    public static async Task<ValueTuple<TR1, TR2, TR3>> ThenGetAll<T, TR1, TR2, TR3>(this Task<T> task,
        Func<T, TR1> fr1,
        Func<T, TR2> fr2,
        Func<T, TR3> fr3)
    {
    ...
    public static async Task<ValueTuple<TR1, TR2, TR3, TR4>> ThenGetAll<T, TR1, TR2, TR3, TR4>(this Task<T> task,
        Func<T, TR1> fr1,
        Func<T, TR2> fr2,
        Func<T, TR3> fr3,
        Func<T, TR4> fr4)
    ...
    public static async Task<ValueTuple<TR1, TR2>> ThenGetAll<T1, T2, TR1, TR2>(this Task<ValueTuple<T1, T2>> task,
        Func<T1, T2, TR1> fr1,
        Func<T1, T2, TR2> fr2)
    {
        var tResult = await task;
    ...
    public static async Task<ValueTuple<TR1, TR2>> ThenGetAllAsync<TR1, TR2>(this Task task,
        Func<Task<TR1>> fr1,
        Func<Task<TR2>> fr2)
    {
        await task;
    ...
    public static async Task<ValueTuple<TR1, TR2, TR3>> ThenGetAllAsync<TR1, TR2, TR3>(this Task task,
        Func<Task<TR1>> fr1,
        Func<Task<TR2>> fr2,
        Func<Task<TR3>> fr3)
    {
    ...
    public static async Task<ValueTuple<TR1, TR2, TR3, TR4>> ThenGetAllAsync<TR1, TR2, TR3, TR4>(this Task task,
        Func<Task<TR1>> fr1,
        Func<Task<TR2>> fr2,
        Func<Task<TR3>> fr3,
        Func<Task<TR4>> fr4)
    ...
    public static async Task<ValueTuple<TR1, TR2>> ThenGetAllAsync<T, TR1, TR2>(this Task<T> task,
        Func<T, Task<TR1>> fr1,
        Func<T, Task<TR2>> fr2)
    {
        var tResult = await task;
    ...
    public static async Task<ValueTuple<TR1, TR2, TR3>> ThenGetAllAsync<T, TR1, TR2, TR3>(this Task<T> task,
        Func<T, Task<TR1>> fr1,
        Func<T, Task<TR2>> fr2,
        Func<T, Task<TR3>> fr3)
    {
    ...
    public static async Task<ValueTuple<TR1, TR2, TR3, TR4>> ThenGetAllAsync<T, TR1, TR2, TR3, TR4>(this Task<T> task,
        Func<T, Task<TR1>> fr1,
        Func<T, Task<TR2>> fr2,
        Func<T, Task<TR3>> fr3,
        Func<T, Task<TR4>> fr4)
        ...
        Func<T, Task<TR5>> fr5)
    {
        var tResult = await task;
        return await Util.TaskRunner.WhenAll(fr1(tResult), fr2(tResult), fr3(tResult),
            fr4(tResult), fr5(tResult));
    }

    public static async Task<ValueTuple<TR1, TR2>> ThenGetAllAsync<T1, T2, TR1, TR2>(this Task<ValueTuple<T1, T2>> task,
    ...
    {
        var tResult = await task;
        return await Util.TaskRunner.WhenAll(fr1(tResult.Item1, tResult.Item2, tResult.Item3),
    ...
    public static async Task<ValueTuple<T, TR1, TR2>> ThenWithAllAsync<T, TR1, TR2>(this Task<T> task,
        Func<T, Task<TR1>> fr1,
        Func<T, Task<TR2>> fr2)
    {
        var tResult = await task;
    ...
    public static async Task<ValueTuple<T, TR1, TR2, TR3>> ThenWithAllAsync<T, TR1, TR2, TR3>(this Task<T> task,
        Func<T, Task<TR1>> fr1,
        Func<T, Task<TR2>> fr2,
        Func<T, Task<TR3>> fr3)
    {
        ...
        Func<T, Task<TR5>> fr5)
    {
        var tResult = await task;
        return await Util.TaskRunner.WhenAll(tResult.ToTask(), fr1(tResult), fr2(tResult),
            fr3(tResult), fr4(tResult), fr5(tResult));
    }
