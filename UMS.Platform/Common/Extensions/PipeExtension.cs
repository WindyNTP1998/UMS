...
public static class PipeExtension
{
    ...
    /// </summary>
    public static TResult PipeIf<TTarget, TResult>(this TTarget target,
        bool when,
    ...
    /// </summary>
    public static TResult PipeIfNotNull<TTarget, TResult>(this TTarget target,
    ...
    ///     Pipe if the value is not null,  or else return default value of return pipe type
    /// </summary>
    public static async Task<TResult> PipeIfNotNull<TTarget, TResult>(this TTarget target,
    ...
    /// </summary>
    public static TResult PipeIfOrDefault<TTarget, TResult>(this TTarget target,
        bool when,
        Func<TTarget, TResult> thenPipe,
        TResult defaultValue = default)
    {
    ...
    /// </summary>
    public static TResult PipeIfNotNullOrDefault<TTarget, TResult>(this TTarget target,
        Func<TTarget, TResult> thenPipe,
        TResult defaultValue = default)
    {
        return target != null ? thenPipe(target) : defaultValue;
    ...
    ///     Pipe if target value is not null, or else return default value of return pipe type
    /// </summary>
    public static async Task<TResult> PipeIfNotNullOrDefault<TTarget, TResult>(this TTarget target,
        Func<TTarget, Task<TResult>> thenPipe,
        TResult defaultValue = default)
    {
        return target != null ? await thenPipe(target) : defaultValue;
