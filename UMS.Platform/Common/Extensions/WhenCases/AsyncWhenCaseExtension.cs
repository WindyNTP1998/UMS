...
public static class AsyncWhenCaseExtension
{
    ...
    {
        return sourceWhenCaseTask.Then(sourceWhenCase => cases.Aggregate(sourceWhenCase,
    ...
    public static Task<WhenCase<TSource>> When<TSource>(this Task<WhenCase<TSource>> sourceWhenCaseTask,
    ...
    public static Task<WhenCase<TSource>> WhenIs<TSource, TSourceIs>(this Task<WhenCase<TSource>> sourceWhenCaseTask,
    ...
    public static Task<WhenCase<TSource>> WhenValue<TSource>(this Task<WhenCase<TSource>> sourceWhenCaseTask,
        TSource @case,
        Action<TSource> then)
    {
        return sourceWhenCaseTask.Then(sourceWhenCase => sourceWhenCase.WhenValue(@case, then));
    ...
    public static Task<WhenCase<TSource>> Else<TSource>(this Task<WhenCase<TSource>> sourceWhenCaseTask,
        Func<Task> then)
    {
        return sourceWhenCaseTask.Then(_ => _.Else(then));
    }
