...
{
    public static WhenCase<TSource, TTarget> When<TSource, TTarget>(this TSource source,
    ...
    public static WhenCase<TSource> When<TSource>(this TSource source,
    ...
    /// </summary>
    public static WhenCase<TSource, TTarget> WhenIs<TSource, TSourceIs, TTarget>(this TSource source,
    ...
    ///     Ex: WhenIs[SomeTypeToCheckThatTheTargetObjTypeIsThisType]
    /// </summary>
    public static WhenCase<TSource> WhenIs<TSource, TSourceIs>(this TSource source,
    ...
    public static WhenCase<TSource, TTarget> WhenValue<TSource, TTarget>(this TSource source,
        TSource @case,
        Func<TSource, TTarget> then)
    {
    ...
    public static WhenCase<TSource> WhenValue<TSource>(this TSource source,
        TSource @case,
        Action<TSource> then)
    {
