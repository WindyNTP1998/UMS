...
public static class DependencyInjectionExtension
{
    ...
    private static readonly Dictionary<string, Func<IServiceProvider, object>>
        RegisteredHostedServiceImplementTypeToImplementFactoryDict = new();

    private static readonly ConcurrentDictionary<string, object> RegisterHostedServiceLockDict = new();

    public static string[] DefaultIgnoreRegisterLibraryInterfacesNameSpacePrefixes { get; set; } =
        { "System", "Microsoft" };
    ...
    ///     interfaces
    /// </summary>
    public static IServiceCollection RegisterAllFromType(this IServiceCollection services,
        ...
        CheckRegisteredStrategy skipIfExistStrategy = CheckRegisteredStrategy.ByBoth)
    {
        assembly.GetTypes()
            ...
            {
                services.Register(implementationType,
                    lifeTime,
                    replaceIfExist,
                    replaceStrategy,
                    skipIfExist,
                ...
                services.RegisterInterfacesForImplementation(implementationType,
                    lifeTime,
                    replaceIfExist,
                    replaceStrategy,
                    skipIfExist,
    ...
    /// </summary>
    public static IServiceCollection RegisterAllSelfImplementationFromType(this IServiceCollection services,
        Type conventionalType,
        Assembly assembly,
        ServiceLifeTime lifeTime = ServiceLifeTime.Transient,
        bool replaceIfExist = true,
    ...
    ///     interfaces
    /// </summary>
    public static IServiceCollection RegisterAllFromType<TConventional>(this IServiceCollection services,
        Assembly assembly,
        ServiceLifeTime lifeTime = ServiceLifeTime.Transient,
        bool replaceIfExist = true,
        CheckRegisteredStrategy replaceStrategy = CheckRegisteredStrategy.ByBoth,
        ...
        CheckRegisteredStrategy skipIfExistStrategy = CheckRegisteredStrategy.ByBoth)
    {
        return RegisterAllFromType(services,
    ...
    public static IServiceCollection RegisterAllSelfImplementationFromType<TConventional>(
        ...
        CheckRegisteredStrategy skipIfExistStrategy = CheckRegisteredStrategy.ByBoth)
    {
        return RegisterAllSelfImplementationFromType(services,
            typeof(TConventional),
            assembly,
            lifeTime,
            replaceIfExist,
    ...
    /// </summary>
    public static IServiceCollection RegisterAllForImplementation(this IServiceCollection services,
    ...
    {
        services.RegisterIfNotExist(implementationType, implementationType, lifeTime,
            CheckRegisteredStrategy.ByBoth);
    ...
    /// <summary>
    ///     <inheritdoc
    ///         cref="RegisterAllForImplementation(IServiceCollection,Type,ServiceLifeTime,bool,CheckRegisteredStrategy)" />
    /// </summary>
    public static IServiceCollection RegisterAllForImplementation<TImplementation>(this IServiceCollection services,
        ServiceLifeTime lifeTime = ServiceLifeTime.Transient,
        bool replaceIfExist = true,
        CheckRegisteredStrategy replaceStrategy = CheckRegisteredStrategy.ByBoth)
    {
        return RegisterAllForImplementation(services,
    ...
    public static IServiceCollection RegisterAllForImplementation<TImplementation>(this IServiceCollection services,
        ...
        bool replaceIfExist = true)
    {
        services.Register(typeof(TImplementation),
            implementationFactory,
            lifeTime,
            replaceIfExist);
        ...
        CheckRegisteredStrategy skipIfExistStrategy = CheckRegisteredStrategy.ByBoth)
    {
        if (skipIfExist)
        {
            if (skipIfExistStrategy == CheckRegisteredStrategy.ByBoth &&
                services.Any(p => p.ServiceType == serviceType && p.ImplementationType == implementationType))
                return services;
            if (skipIfExistStrategy == CheckRegisteredStrategy.ByService &&
                services.Any(p => p.ServiceType == serviceType))
                return services;
            if (skipIfExistStrategy == CheckRegisteredStrategy.ByImplementation &&
                services.Any(p => p.ImplementationType == implementationType))
                return services;
        }
    ...
    public static IServiceCollection RegisterIfNotExist<TService, TImplementation>(this IServiceCollection services,
        ServiceLifeTime lifeTime,
        CheckRegisteredStrategy checkExistingStrategy)
    {
        return RegisterIfNotExist(services,
            typeof(TService),
            typeof(TImplementation),
            lifeTime,
    ...
    public static IServiceCollection RegisterIfNotExist(this IServiceCollection services,
        Type serviceType,
        Type implementationType,
        ServiceLifeTime lifeTime,
        CheckRegisteredStrategy checkExistingStrategy)
    ...
    public static IServiceCollection RegisterIfServiceNotExist<TService, TImplementation>(
        ...
        ServiceLifeTime lifeTime = ServiceLifeTime.Transient)
    {
        return RegisterIfServiceNotExist(services,
            typeof(TService),
            typeof(TImplementation),
            lifeTime);
    }

    public static IServiceCollection RegisterIfServiceNotExist(this IServiceCollection services,
        Type serviceType,
        Type implementationType,
        ServiceLifeTime lifeTime = ServiceLifeTime.Transient)
    {
    ...
    public static IServiceCollection RegisterIfServiceNotExist<TImplementation>(this IServiceCollection services,
        Type serviceType,
    ...
    public static IServiceCollection Register<TService>(this IServiceCollection services,
        ServiceLifeTime lifeTime = ServiceLifeTime.Transient,
        bool replaceIfExist = true,
        CheckRegisteredStrategy replaceStrategy = CheckRegisteredStrategy.ByBoth)
    {
    ...
    public static IServiceCollection RegisterInstance<TService>(this IServiceCollection services,
        TService instance,
        bool replaceIfExist = true,
        CheckRegisteredStrategy replaceStrategy = CheckRegisteredStrategy.ByBoth)
    {
    ...
    public static IServiceCollection Register<TImplementation>(this IServiceCollection services,
        Type serviceType,
        Func<IServiceProvider, TImplementation> implementationFactory,
        ServiceLifeTime lifeTime = ServiceLifeTime.Transient,
        bool replaceIfExist = true,
    ...
    {
        services.Register(hostedServiceType, ServiceLifeTime.Singleton);
        ...
        lock (RegisterHostedServiceLockDict[hostedServiceType.FullName!])
        {
            ...
            {
                RegisteredHostedServiceImplementTypeToImplementFactoryDict.Add(hostedServiceType.FullName!,
                    sp => sp.GetRequiredService(hostedServiceType));
        ...
        if (replaceForHostedServiceType != null)
        {
            services.RemoveWhere(p => p.ImplementationType == replaceForHostedServiceType ||
                                      ...
                                      p.ImplementationFactory ==
                                      RegisteredHostedServiceImplementTypeToImplementFactoryDict[
                                          hostedServiceType.FullName!]);

            services.Register(replaceForHostedServiceType,
                RegisteredHostedServiceImplementTypeToImplementFactoryDict[hostedServiceType.FullName!],
                ServiceLifeTime.Singleton);
        }
    ...
    public static IServiceCollection RegisterHostedService<THostedService>(this IServiceCollection services,
    ...
    public static IServiceCollection RegisterHostedServicesFromType(this IServiceCollection services,
        Assembly assembly,
        Type conventionalType)
    {
        assembly.GetTypes()
            .Where(implementationType => implementationType.IsClass &&
                                         ...
                                         implementationType.IsAssignableTo(conventionalType))
            .ForEach(implementHostedServiceType => { RegisterHostedService(services, implementHostedServiceType); });
    ...
    public static IServiceCollection ReplaceScoped(this IServiceCollection services,
        Type serviceType,
        Type implementationType,
        CheckRegisteredStrategy replaceStrategy = CheckRegisteredStrategy.ByBoth)
    {
    ...
    public static IServiceCollection ReplaceSingleton(this IServiceCollection services,
        Type serviceType,
        Type implementationType,
        CheckRegisteredStrategy replaceStrategy = CheckRegisteredStrategy.ByBoth)
    {
    ...
    public static IServiceCollection ReplaceTransient<TImplementation>(this IServiceCollection services,
        Type serviceType,
        Func<IServiceProvider, TImplementation> implementationFactory,
        CheckRegisteredStrategy replaceStrategy = CheckRegisteredStrategy.ByBoth)
    {
    ...
    public static IServiceCollection ReplaceScoped<TImplementation>(this IServiceCollection services,
        Type serviceType,
        Func<IServiceProvider, TImplementation> implementationFactory,
        CheckRegisteredStrategy replaceStrategy = CheckRegisteredStrategy.ByBoth)
    {
    ...
    public static IServiceCollection ReplaceSingleton<TImplementation>(this IServiceCollection services,
        Type serviceType,
        Func<IServiceProvider, TImplementation> implementationFactory,
        CheckRegisteredStrategy replaceStrategy = CheckRegisteredStrategy.ByBoth)
    {
    ...
    public static IServiceCollection RemoveIfExist(this IServiceCollection services,
    ...
    public static IServiceCollection RemoveIfExist(IServiceCollection services,
        Type serviceType,
        Type implementationType,
        CheckRegisteredStrategy replaceStrategy = CheckRegisteredStrategy.ByBoth)
    {
        return replaceStrategy switch
        {
            ...
            CheckRegisteredStrategy.ByImplementation => RemoveIfExist(services,
                p => p.ImplementationType == implementationType),
            CheckRegisteredStrategy.ByBoth => RemoveIfExist(services,
    ...
    public static void RegisterInterfacesForImplementation(this IServiceCollection services,
        Type implementationType,
        ServiceLifeTime lifeTime,
        bool replaceIfExist,
        CheckRegisteredStrategy replaceStrategy = CheckRegisteredStrategy.ByBoth,
    ...
    public static Func<Type, bool> DefaultIgnoreRegisterLibraryInterfacesForImplementationExpr()
    {
        return implementationTypeInterface =>
            DefaultIgnoreRegisterLibraryInterfacesNameSpacePrefixes.NotExist(prefix =>
                implementationTypeInterface.FullName?.StartsWith(prefix) == true);
    }

    public static void RegisterInterfacesForImplementation<TImplementation>(this IServiceCollection services,
        Func<IServiceProvider, TImplementation> implementationFactory,
        ServiceLifeTime lifeTime,
        bool replaceIfExist,
        CheckRegisteredStrategy replaceStrategy = CheckRegisteredStrategy.ByBoth)
    {
        RegisterInterfacesForImplementation(services,
            typeof(TImplementation),
    ...
    ///     Example: method = (T1 param1, T2 param2); serviceProvider.ResolveMethodParameters(method, null, customParam2Value)
    ///     equal to method(serviceProvider.GetService[T1](),customParam2Value)
    /// </summary>
    public static object[] ResolveMethodParameters(this IServiceProvider serviceProvider, Delegate method,
    ...
    public static object[] ResolveMethodParameters(this IServiceScope scope, Delegate method,
        params object[] manuallyParams)
    {
    ...
    ///     If method = (T1 param1, T2 param2) then it equivalent to
    ///     method(serviceProvider.GetService[T1](),serviceProvider.GetService[T2]>()) <br />
    ///     manuallyParams to override using based on param index and it's not null. <br />
    ///     Example: serviceProvider.ExecuteInject(method, null, customParam2Value) equal to
    ///     method(serviceProvider.GetService[T1](),customParam2Value)
    /// </summary>
    public static void ExecuteInject(this IServiceProvider serviceProvider, Delegate method,
        params object[] manuallyParams)
    {
    ...
    public static TResult ExecuteInject<TResult>(this IServiceProvider serviceProvider, Delegate method,
        params object[] manuallyParams)
    {
        var parameters = serviceProvider.ResolveMethodParameters(method, manuallyParams);
    ...
    /// <inheritdoc cref="ExecuteInject(IServiceProvider,Delegate,object[])" />
    public static async Task ExecuteInjectAsync(this IServiceProvider serviceProvider, Delegate method,
        params object[] manuallyParams)
    {
        var parameters = serviceProvider.ResolveMethodParameters(method, manuallyParams);
    ...
    /// <inheritdoc cref="ExecuteInject(IServiceProvider,Delegate,object[])" />
    public static async Task<TResult> ExecuteInjectAsync<TResult>(this IServiceProvider serviceProvider,
        Delegate method, params object[] manuallyParams)
    {
        var parameters = serviceProvider.ResolveMethodParameters(method, manuallyParams);
    ...
    /// <inheritdoc cref="ExecuteInject(IServiceProvider,Delegate,object[])" />
    public static TResult ExecuteInject<TResult>(this IServiceScope scope, Delegate method,
        params object[] manuallyParams)
    {
        var parameters = scope.ResolveMethodParameters(method, manuallyParams);
    ...
    /// <inheritdoc cref="ExecuteInject(IServiceProvider,Delegate,object[])" />
    public static async Task ExecuteInjectAsync(this IServiceScope scope, Delegate method,
        params object[] manuallyParams)
    {
        var parameters = scope.ResolveMethodParameters(method, manuallyParams);
    ...
    /// <inheritdoc cref="ExecuteInject(IServiceProvider,Delegate,object[])" />
    public static async Task<TResult> ExecuteInjectAsync<TResult>(this IServiceScope scope, Delegate method,
        params object[] manuallyParams)
    {
        method.Method
            .Validate(methodInfo => methodInfo.GetParameters().Length >= manuallyParams.Length &&
                                    manuallyParams.All((manuallyParam, index) =>
                                        manuallyParam?.GetType() == null || manuallyParam.GetType() ==
                                        methodInfo.GetParameters()[index].ParameterType),
                "Delegate method parameters signature must start with all parameters correspond to manuallyParams")
            .EnsureValid();
    ...
    public static TResult ExecuteScoped<TResult>(this IServiceProvider serviceProvider,
        Func<IServiceScope, TResult> method)
    {
        using (var scope = serviceProvider.CreateScope())
        {
    ...
    /// <inheritdoc cref="ExecuteScoped" />
    public static async Task<TResult> ExecuteScopedAsync<TResult>(this IServiceProvider serviceProvider,
        Func<IServiceScope, Task<TResult>> method)
    {
        using (var scope = serviceProvider.CreateScope())
        {
    ...
    ///     If method = (T1 param1, T2 param2) then it equivalent to using(var scope = serviceProvider.CreateScope()) =>
    ///     method(scope.ServiceProvider.GetService[T1](), scope.ServiceProvider.GetService[T2]>())
    ///     manuallyParams to override using based on param index and it's not null. <br />
    ///     Example: serviceProvider.ExecuteInject(method, null, customParam2Value) equal to
    ///     method(serviceProvider.GetService[T1](),customParam2Value)
    /// </summary>
    public static void ExecuteInjectScoped(this IServiceProvider serviceProvider, Delegate method,
        params object[] manuallyParams)
    {
    ...
    public static TResult ExecuteInjectScoped<TResult>(this IServiceProvider serviceProvider, Delegate method,
        params object[] manuallyParams)
    {
    ...
    /// <inheritdoc cref="ExecuteInjectScoped" />
    public static Task ExecuteInjectScopedAsync(this IServiceProvider serviceProvider, Delegate method,
        params object[] manuallyParams)
    {
    ...
    /// <inheritdoc cref="ExecuteInjectScoped" />
    public static Task<TResult> ExecuteInjectScopedAsync<TResult>(this IServiceProvider serviceProvider,
        Delegate method, params object[] manuallyParams)
    {
    ...
    public static async Task ExecuteInjectScopedPagingAsync(this IServiceProvider serviceProvider,
        long maxItemCount,
        int pageSize,
        Delegate method,
        params object[] manuallyParams)
    {
        method.Method
            .Validate(p => p.GetParameters().Length >= 2 &&
                           p.GetParameters().Take(2).All(_ => _.ParameterType == typeof(int)),
                "Method parameters must start with (int skipCount, int pageSize)")
            .EnsureValid();

        await Util.Pager.ExecutePagingAsync(async (skipCount, pageSize) =>
            {
                await serviceProvider.ExecuteInjectScopedAsync(method,
                    Util.ListBuilder.NewArray<object>(skipCount, pageSize).Concat(manuallyParams).ToArray());
            },
            maxItemCount,
            pageSize);
    }
        ...
        params object[] manuallyParams)
    {
        ...
        await Util.Pager.ExecutePagingAsync(async (skipCount, pageSize) =>
            {
                await Util.TaskRunner.WaitRetryThrowFinalExceptionAsync(() => serviceProvider.ExecuteInjectScopedAsync(
                        method,
                        Util.ListBuilder.NewArray<object>(skipCount, pageSize).Concat(manuallyParams).ToArray()),
    ...
    ///     Then the "manuallyParams" for the method. And the last will be the object you want to be dependency injected
    /// </summary>
    public static Task ExecuteInjectScopedScrollingPagingAsync<TItem>(this IServiceProvider serviceProvider,
