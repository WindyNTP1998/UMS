...
public static class DictionaryExtension
{
    ...
    /// </summary>
    public static TDic Upsert<TDic, TKey, TValue>(this TDic dictionary, TKey key, TValue value)
    ...
    public static TDic UpsertMany<TDic, TKey, TValue>(this TDic dictionary, IDictionary<TKey, TValue> values)
        where TDic : IDictionary<TKey, TValue>
    {
    ...
    public static IDictionary<TKey, TValue> Upsert<TKey, TValue>(this IDictionary<TKey, TValue> dictionary, TKey key,
        TValue value)
    {
        if (dictionary.ContainsKey(key))
            dictionary[key] = value;
    ...
    public static ConcurrentDictionary<TKey, TValue> Upsert<TKey, TValue>(
