...
namespace UMS.Platform.Common.Validations.Validators;

public class PlatformValidator<T> : AbstractValidator<T>
{
    public static PlatformValidationResult Invalid<TObjectTarget>(TObjectTarget objectTarget, string property,
        string errorMsg)
    {
        return PlatformValidationResult<TObjectTarget>.Invalid(objectTarget,
            new PlatformValidationError(property, errorMsg));
    }
    ...
    public override PlatformValidationResult Validate(ValidationContext<T> context)
    {
        ...
        return new PlatformValidationResult<object>(context.InstanceToValidate,
    ...
    {
        return new PlatformValidationResult<T>(instance,
