...
namespace UMS.Platform.Common.Validations.Extensions;

public static class PlatformAsyncValidateExtension
{
    public static Task<PlatformValidationResult<TValue>> ValidateAsync<TValue>(this TValue value,
    ...
    public static Task<PlatformValidationResult<TValue>> ValidateNotAsync<TValue>(this TValue value,
        Func<TValue, Task<bool>> mustNot,
        params PlatformValidationError[] errorMsgs)
    {
        return mustNot(value)
            .Then(mustNotValue => PlatformValidationResult<TValue>.Validate(value, !mustNotValue, errorMsgs));
    }
    ...
    {
        return must(value)
            .Then(mustValue => PlatformValidationResult<TValue>.Validate(value, mustValue, errorMsg(value)));
    }
    ...
    public static Task<PlatformValidationResult> AndAsync(this Task<PlatformValidationResult> sourceValidationTask,
        Func<PlatformValidationResult> nextValidation)
    {
        return sourceValidationTask.Then(p => p.And(nextValidation));
    }

    public static Task<PlatformValidationResult> AndAsync(this Task<PlatformValidationResult> sourceValidation,
    ...
    public static Task<T> EnsureValidAsync<T>(this Task<PlatformValidationResult<T>> sourceValidationTask)
    {
        return sourceValidationTask.Then(p => p.EnsureValid());
    }

    public static Task<PlatformValidationResult<TValue>> ThenValidateAsync<TValue>(this Task<TValue> valueTask,
        bool must,
        params PlatformValidationError[] errors)
    {
    ...
    public static Task<PlatformValidationResult<List<T>?>> ThenValidateFoundAllAsync<T>(this Task<List<T>> objectsTask,
    ...
    public static Task<PlatformValidationResult<T>> ThenValidateFoundAsync<T>(this Task<T?> objTask,
    ...
    public static Task<PlatformValidationResult<TValue>> ThenValidateNotAsync<TValue>(this Task<TValue> valueTask,
        Func<TValue, bool> mustNot,
        params PlatformValidationError[] errorMsgs)
    {
        return valueTask.Then(value =>
            PlatformValidationResult<TValue>.ValidateNot(value, () => mustNot(value), errorMsgs));
    }
    ...
    {
        return valueTask.Then(value =>
            PlatformValidationResult<TValue>.ValidateNot(value, () => mustNot(value), errorMsgs(value)));
    }
    ...
    public static Task<PlatformValidationResult<TR>> WaitValidThen<T, TR>(this Task<PlatformValidationResult<T>> task,
        Func<T, TR> next)
    {
    ...
    {
        var taskResultVal = await task;
        return await taskResultVal.ThenAsync(taskResult =>
            nextTask(taskResult.Item1, taskResult.Item2, taskResult.Item3));
    }
    ...
    public static async Task<PlatformValidationResult<ValueTuple<T, TR1, TR2, TR3>>>
        WaitValidThenWithAll<T, TR1, TR2, TR3>(this Task<PlatformValidationResult<T>> task,
            Func<T, TR1> fr1,
            Func<T, TR2> fr2,
            Func<T, TR3> fr3)
    {
        var tResultVal = await task;
        return tResultVal.Then<ValueTuple<T, TR1, TR2, TR3>>(tResult =>
            (tResult, fr1(tResult), fr2(tResult), fr3(tResult)));
    }

    public static async Task<PlatformValidationResult<ValueTuple<T, TR1, TR2, TR3, TR4>>>
        WaitValidThenWithAll<T, TR1, TR2, TR3, TR4>(this Task<PlatformValidationResult<T>> task,
            Func<T, TR1> fr1,
            Func<T, TR2> fr2,
            Func<T, TR3> fr3,
            Func<T, TR4> fr4)
    {
        var tResultVal = await task;
        return tResultVal.Then<ValueTuple<T, TR1, TR2, TR3, TR4>>(tResult =>
            (tResult, fr1(tResult), fr2(tResult), fr3(tResult), fr4(tResult)));
    }

    public static async Task<PlatformValidationResult<ValueTuple<T, TR1, TR2, TR3, TR4, TR5>>> WaitValidThenWithAll<T,
        TR1, TR2, TR3, TR4, TR5>(this Task<PlatformValidationResult<T>> task,
        Func<T, TR1> fr1,
        Func<T, TR2> fr2,
        Func<T, TR3> fr3,
        Func<T, TR4> fr4,
    ...
    {
        var tResultVal = await task;
        return tResultVal.Then<ValueTuple<T, TR1, TR2, TR3, TR4, TR5>>(tResult =>
            (tResult, fr1(tResult), fr2(tResult), fr3(tResult), fr4(tResult), fr5(tResult)));
    }
    ...
    {
        var tResultVal = await task;
        return await tResultVal.ThenAsync(tResult =>
            Util.TaskRunner.WhenAll(tResult.ToTask(), fr1(tResult), fr2(tResult)));
    }

    public static async Task<PlatformValidationResult<ValueTuple<T, TR1, TR2, TR3>>>
        WaitValidThenWithAllAsync<T, TR1, TR2, TR3>(this Task<PlatformValidationResult<T>> task,
            Func<T, Task<TR1>> fr1,
            Func<T, Task<TR2>> fr2,
            Func<T, Task<TR3>> fr3)
    {
    ...
    public static async Task<PlatformValidationResult<ValueTuple<T, TR1, TR2, TR3, TR4>>>
        WaitValidThenWithAllAsync<T, TR1, TR2, TR3, TR4>(this Task<PlatformValidationResult<T>> task,
            Func<T, Task<TR1>> fr1,
            Func<T, Task<TR2>> fr2,
            Func<T, Task<TR3>> fr3,
            Func<T, Task<TR4>> fr4)
    ...
    public static async Task<PlatformValidationResult<ValueTuple<T, TR1, TR2, TR3, TR4, TR5>>>
        WaitValidThenWithAllAsync<T, TR1, TR2, TR3, TR4, TR5>(this Task<PlatformValidationResult<T>> task,
            Func<T, Task<TR1>> fr1,
            Func<T, Task<TR2>> fr2,
            Func<T, Task<TR3>> fr3,
            Func<T, Task<TR4>> fr4,
    ...
    {
        var tResultVal = await task;
        return await tResultVal.ThenAsync(tResult => Util.TaskRunner.WhenAll(tResult.ToTask(), fr1(tResult),
            fr2(tResult), fr3(tResult), fr4(tResult),
            fr5(tResult)));
    }
    ...
    public static async Task<PlatformValidationResult<ValueTuple<TR1, TR2, TR3, TR4>>> WaitValidThenGetAll<T, TR1, TR2,
        TR3, TR4>(this Task<PlatformValidationResult<T>> task,
        Func<T, TR1> fr1,
        Func<T, TR2> fr2,
        Func<T, TR3> fr3,
        Func<T, TR4> fr4)
    ...
    public static async Task<PlatformValidationResult<ValueTuple<TR1, TR2, TR3, TR4, TR5>>> WaitValidThenGetAll<T, TR1,
        TR2, TR3, TR4, TR5>(this Task<PlatformValidationResult<T>> task,
        Func<T, TR1> fr1,
        Func<T, TR2> fr2,
        Func<T, TR3> fr3,
        Func<T, TR4> fr4,
    ...
    public static async Task<PlatformValidationResult<ValueTuple<TR1, TR2, TR3>>>
        WaitValidThenGetAllAsync<T, TR1, TR2, TR3>(this Task<PlatformValidationResult<T>> task,
            Func<T, Task<TR1>> fr1,
            Func<T, Task<TR2>> fr2,
            Func<T, Task<TR3>> fr3)
    {
    ...
    public static async Task<PlatformValidationResult<ValueTuple<TR1, TR2, TR3, TR4>>>
        WaitValidThenGetAllAsync<T, TR1, TR2, TR3, TR4>(this Task<PlatformValidationResult<T>> task,
            Func<T, Task<TR1>> fr1,
            Func<T, Task<TR2>> fr2,
            Func<T, Task<TR3>> fr3,
            Func<T, Task<TR4>> fr4)
    ...
    public static async Task<PlatformValidationResult<ValueTuple<TR1, TR2, TR3, TR4, TR5>>> WaitValidThenGetAllAsync<T,
        TR1, TR2, TR3, TR4, TR5>(this Task<PlatformValidationResult<T>> task,
        Func<T, Task<TR1>> fr1,
        Func<T, Task<TR2>> fr2,
        Func<T, Task<TR3>> fr3,
        ...
        Func<T1, T2, Task<TR2>> fr2)
    {
        var tResultVal = await task;
        return await tResultVal.ThenAsync(tResult =>
            Util.TaskRunner.WhenAll(fr1(tResult.Item1, tResult.Item2), fr2(tResult.Item1, tResult.Item2)));
    }

    public static async Task<PlatformValidationResult<ValueTuple<TR1, TR2, TR3>>>
        WaitValidThenGetAllAsync<T1, T2, TR1, TR2, TR3>(this Task<PlatformValidationResult<ValueTuple<T1, T2>>> task,
            Func<T1, T2, Task<TR1>> fr1,
            Func<T1, T2, Task<TR2>> fr2,
            Func<T1, T2, Task<TR3>> fr3)
    {
        var tResultVal = await task;
        return await tResultVal.ThenAsync(tResult => Util.TaskRunner.WhenAll(fr1(tResult.Item1, tResult.Item2),
            fr2(tResult.Item1, tResult.Item2),
            fr3(tResult.Item1, tResult.Item2)));
    }

    public static async Task<PlatformValidationResult<ValueTuple<TR1, TR2>>>
        WaitValidThenGetAllAsync<T1, T2, T3, TR1, TR2>(this Task<PlatformValidationResult<ValueTuple<T1, T2, T3>>> task,
            Func<T1, T2, T3, Task<TR1>> fr1,
            Func<T1, T2, T3, Task<TR2>> fr2)
    {
        var tResultVal = await task;
        return await tResultVal.ThenAsync(tResult =>
            Util.TaskRunner.WhenAll(fr1(tResult.Item1, tResult.Item2, tResult.Item3),
                fr2(tResult.Item1, tResult.Item2, tResult.Item3)));
    }

    public static async Task<PlatformValidationResult<ValueTuple<TR1, TR2, TR3>>>
        WaitValidThenGetAllAsync<T1, T2, T3, TR1, TR2, TR3>(
            this Task<PlatformValidationResult<ValueTuple<T1, T2, T3>>> task,
            Func<T1, T2, T3, Task<TR1>> fr1,
            Func<T1, T2, T3, Task<TR2>> fr2,
    ...
    {
        var tResultVal = await task;
        return await tResultVal.ThenAsync(tResult => Util.TaskRunner.WhenAll(
    ...
    public static async Task<PlatformValidationResult<ValueTuple<TR1, TR2, TR3>>>
        WaitValidThenGetAll<T1, T2, TR1, TR2, TR3>(this Task<PlatformValidationResult<ValueTuple<T1, T2>>> task,
            Func<T1, T2, TR1> fr1,
            Func<T1, T2, TR2> fr2,
            Func<T1, T2, TR3> fr3)
    {
    ...
    {
        var tResultVal = await task;
        return tResultVal.Then(tResult => (fr1(tResult.Item1, tResult.Item2, tResult.Item3),
            fr2(tResult.Item1, tResult.Item2, tResult.Item3)));
    }

    public static async Task<PlatformValidationResult<ValueTuple<TR1, TR2, TR3>>>
        WaitValidThenGetAll<T1, T2, T3, TR1, TR2, TR3>(this Task<PlatformValidationResult<ValueTuple<T1, T2, T3>>> task,
            Func<T1, T2, T3, TR1> fr1,
            Func<T1, T2, T3, TR2> fr2,
            Func<T1, T2, T3, TR3> fr3)
    {
        var tResultVal = await task;
        return tResultVal.Then(tResult =>
            (fr1(tResult.Item1, tResult.Item2, tResult.Item3),
                fr2(tResult.Item1, tResult.Item2, tResult.Item3),
                fr3(tResult.Item1, tResult.Item2, tResult.Item3)));
    }
