...
{
    public PlatformValidationError(ValidationFailure failure) : base(failure.PropertyName,
    ...
    public PlatformValidationError(string propertyName, string errorMessage, object attemptedValue) : base(propertyName,
        errorMessage,
        attemptedValue)
    {
    }
    ...
    public static PlatformValidationError Create(string message,
        string propName,
