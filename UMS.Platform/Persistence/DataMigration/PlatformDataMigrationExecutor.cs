...
namespace UMS.Platform.Persistence.DataMigration;
...
{
    /// <summary>
    ///     The unique name of the migration. The name will be used to order. Convention should be:
...
/// <summary>
///     This class is used to run APPLICATION DATA migration, when you need to migrate your data in your whole micro
    ...
    where TDbContext : IPlatformDbContext
{
    ...
    public static List<PlatformDataMigrationExecutor<TDbContext>> ScanAllDataMigrationExecutors(Assembly scanAssembly,
    ...
    public static PlatformDataMigrationExecutor<TDbContext> CreateNewInstance(IServiceProvider serviceProvider,
        Type migrationType)
    {
        return ActivatorUtilities.CreateInstance(serviceProvider, migrationType)
            .As<PlatformDataMigrationExecutor<TDbContext>>();
    }

    public static void EnsureAllDataMigrationExecutorsHasUniqueName(Assembly scanAssembly,
        IServiceProvider serviceProvider)
    {
